...
return(
        ...
        <div className="container1-full">
          <div className="footer1-content">
            <div className="footer1-left">
              <div className="footer1-logo">
                <img src={LOGO} alt="Qaidyn Partners Logo" className="footer1-logo-image" />
              </div>
            </div>
          ...
          <div className="footer1-bottom">
            ...
            <a href="#terms">Terms Conditions</a>
              ...
              <div className="footer1-social">
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="social-icon1">
                ...
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="social-icon1">
